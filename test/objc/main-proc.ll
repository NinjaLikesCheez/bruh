...
define internal %0* @"-[StringGetterer getStringFor:]"(%1* %0, i8* %1, i64 %2) #1 {
  %4 = alloca %0*, align 8
  %5 = alloca %1*, align 8
  %6 = alloca i8*, align 8
...
declare i8* @llvm.objc.retain(i8* %0) #2

; Function Attrs: nounwind
declare i8* @llvm.objc.autoreleaseReturnValue(i8* %0) #2

; Function Attrs: noinline optnone ssp uwtable
define internal %0* @"+[SeparatorGetterer getSeparator]"(i8* %0, i8* %1) #1 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: nounwind
declare i8* @llvm.objc.retainAutoreleaseReturnValue(i8* %0) #2

; Function Attrs: noinline optnone ssp uwtable
define internal i8* @"-[ExclaimationGetterer initWithExclaimation:]"(%2* %0, i8* %1, %0* %2) #1 {
  %4 = alloca %2*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %0*, align 8
...
23:                                               ; preds = %3
  ...
  call void @"-[ExclaimationGetterer setExclaimation:]"(i8* %27, i8* %26, %0* %24)
  br label %28
...
; Function Attrs: nounwind
declare void @llvm.objc.storeStrong(i8** %0, i8* %1) #2

declare i8* @objc_msgSendSuper2(%struct._objc_super* %0, i8* %1, ...)

; Function Attrs: nounwind
declare i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %0) #2

; Function Attrs: nounwind
declare void @llvm.objc.release(i8* %0) #2

; Function Attrs: nonlazybind
declare i8* @objc_msgSend(i8* %0, i8* %1, ...) #3

; Function Attrs: noinline optnone ssp uwtable
define internal %0* @"-[ExclaimationGetterer getExclaimation]"(%2* %0, i8* %1) #1 {
  %3 = alloca %2*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline optnone ssp uwtable
define internal %0* @"-[ExclaimationGetterer exclaimation]"(%2* %0, i8* %1) #1 {
  %3 = alloca %2*, align 8
  %4 = alloca i8*, align 8
  store %2* %0, %2** %3, align 8
  store i8* %1, i8** %4, align 8
...
; Function Attrs: noinline optnone ssp uwtable
define internal void @"-[ExclaimationGetterer setExclaimation:]"(%2* %0, i8* %1, %0* %2) #1 {
  %4 = alloca %2*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %0*, align 8
  store %2* %0, %2** %4, align 8
...
; Function Attrs: noinline optnone ssp uwtable
define internal void @"-[ExclaimationGetterer .cxx_destruct]"(%2* %0, i8* %1) #1 {
  %3 = alloca %2*, align 8
  %4 = alloca i8*, align 8
  store %2* %0, %2** %3, align 8
  store i8* %1, i8** %4, align 8
...
define i32 @main(i32 %0, i8** %1, i8** %2, i8** %3) #4 {
  ...
  %28 = call %0* @"-[StringGetterer getStringFor:]"(i8* %27, i8* %26, i64 0)
  ...
  %35 = call %0* @"+[SeparatorGetterer getSeparator]"(i8* %34, i8* %33)
  ...
  %49 = call %0* @"-[ExclaimationGetterer getExclaimation]"(i8* %48, i8* %47)
...
declare i8* @objc_alloc_init(i8* %0)

declare i8* @objc_alloc(i8* %0)

declare void @NSLog(i8* %0, ...) #5

; Function Attrs: nounwind
declare void @llvm.objc.autoreleasePoolPop(i8* %0) #2

; uselistorder directives
uselistorder i8* (i8*)* @llvm.objc.retain, { 0, 2, 1 }
uselistorder void (i8**, i8*)* @llvm.objc.storeStrong, { 0, 1, 2, 3, 6, 5, 4 }
uselistorder void (%2*, i8*, %0*)* @"-[ExclaimationGetterer setExclaimation:]", { 1, 0 }
